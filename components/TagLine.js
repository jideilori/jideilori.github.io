	...
	return (
		<div>
			<div data-aos="zoom-in-left" className="flex flex-wrap justify-between md:justify-start px-4 md:px-0">
				...
				<a className="flex justify-center items-center w-8 h-8 text-white text-xl md:mr-4 bg-blue-400 rounded-full" href="https://twitter.com/_jideilori">
					<i className="fab fa-twitter"></i>
				</a>
				<a className="flex justify-center items-center w-8 h-8 text-white text-xl md:mr-4 bg-blue-700 rounded-full" href="https://www.linkedin.com/in/oluwaseun-Ilori/">
					<i className="fab fa-linkedin-in"></i>
				</a>
				<a className="flex justify-center items-center w-8 h-8 text-white text-xl md:mr-4 bg-black rounded-full" href="https://jideilori.medium.com/">
